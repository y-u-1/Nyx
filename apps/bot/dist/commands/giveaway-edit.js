...
export const giveawayEdit = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption((opt) => opt.setName("add_duration").setDescription("Extend the end time by this much, e.g. 10m, 1h (use negative-like shorter values are not supported)")),
...
//# sourceMappingURL=giveaway-edit.js.map