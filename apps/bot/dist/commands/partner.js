...
export const partner = {
    data: new SlashCommandBuilder()
        ...
        .addSubcommand((sub) => sub.setName("remove").setDescription("Remove a partner (admin)").addStringOption((opt) => opt.setName("name").setDescription("Partner name").setRequired(true)))
