...
export const automodWords = {
    data: new SlashCommandBuilder()
        .setName("automod-words")
        .setDescription("Manage the AutoMod banned words list.")
        .setDefaultMemberPermissions(PermissionFlagsBits.ManageGuild)
        .addSubcommand((sub) => sub.setName("add").setDescription("Add a banned word or phrase").addStringOption((opt) => opt.setName("word").setDescription("Word or phrase to ban").setRequired(true)))
...
//# sourceMappingURL=automod-words.js.map