...
export const levelConfig = {
    data: new SlashCommandBuilder()
        ...
        .addChannelOption((opt) => opt.setName("level_up_channel").setDescription("Fixed channel for level-up announcements (default: message channel)").addChannelTypes(ChannelType.GuildText)),
...
//# sourceMappingURL=level-config.js.map