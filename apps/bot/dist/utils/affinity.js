...
export function isGestureOnCooldown(gesture, userId1, userId2) {
...
export async function getAffinity(guildId, userId1, userId2) {
...
export async function addAffinity(guildId, userId1, userId2, amount) {
    const [userAId, userBId] = normalizePair(userId1, userId2);
 ...
 */
export async function tryAutoGainAffinity(guildId, userId1, userId2) {
    if (userId1 === userId2)
        return false;
    const [userAId, userBId] = normalizePair(userId1, userId2);
...
export async function getTopPartners(guildId, userId, limit = 5) {
