...
export function xpForLevelStart(targetLevel) {
    let total = 0;
 ...
 */
export async function addXp(client, guildId, userId, amount, notifyChannelId) {
...
async function sendLevelUpAnnouncement(client, guildId, userId, oldLevel, newLevel, fallbackChannelId) {
